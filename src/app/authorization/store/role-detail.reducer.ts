...
const createRoleReducers = createReducer(
    INITIAL_STATE,
    on(fromRoleActions.doFetchRoleSuccess,
        fromRoleActions.doCreateRoleSuccess,
        (state, data) => Object.assign({}, state, {
            loading: false,
            loaded: true,
            failed: false,
            data: data.role
    ...
    on(fromRoleActions.doAssignRole,
    ...
    on(fromRoleActions.doAssignRoleSuccess,
    ...
    on(fromRoleActions.doAssignRoleFail,
