...
const createPermissionReducers = createReducer(
    INITIAL_STATE,
    on(permissionActions.doAttachPermission,
    ...
    on(permissionActions.doAttachPermissionSuccess,
    ...
    on(permissionActions.doAttachPermissionFail,
    ...
    on(permissionActions.doFetchPermissionSuccess,
        (state, perm) => Object.assign({}, state, {
            loading: false,
            loaded: true,
            failed: false,
...
export const reducer = (state: PermissionDetailState | undefined, action: Action) => {
