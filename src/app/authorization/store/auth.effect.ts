...
export class AuthEffects {
        ...
        return this.actions$.pipe(
            ...
            switchMap((roleForm) =>
                this.roleHttpService.assignRole(roleForm).pipe(
                    map(() => { return fromRoleActions.doAssignRoleSuccess() }),
        ...
        return this.actions$.pipe(
            ...
            switchMap((roleForm) =>
                this.roleHttpService.revokeRole(roleForm).pipe(
                    map(() => { return fromRoleActions.doRevokeRoleSuccess() }),
    ...
    this.actions$.pipe(
        ...
        switchMap((roleForm) =>
            this.roleHttpService.syncRole(roleForm).pipe(
                map(() => { return fromRoleActions.doSyncRoleSuccess() }),
        ...
        return this.actions$.pipe(
            ...
            switchMap((permForm) =>
                this.roleHttpService.attachPermission(permForm).pipe(
                    map(() => { return fromPermissionActions.doAttachPermissionSuccess() }),
        ...
        return this.actions$.pipe(
            ...
            switchMap((permForm) =>
                this.roleHttpService.detachPermission(permForm).pipe(
                    map(() => { return fromPermissionActions.doDetachPermissionSuccess() }),
    ...
    doSyncPermissions$ = createEffect(() => {
        return this.actions$.pipe(
            ...
            switchMap((permForm) =>
                this.roleHttpService.detachPermission(permForm).pipe(
                    map(() => { return fromPermissionActions.doSyncPermissionsSuccess() }),
        ...
        this.actions$.pipe(
            ...
            switchMap((criteria) =>
                this.roleHttpService.fetchPermissions(criteria).pipe(
                    map((results) => fromPermissionActions.doFetchPermissionsSuccess({ permissions: results })),
        ...
        this.actions$.pipe(
            ...
            switchMap((id) => 
                this.roleHttpService.fetchPermission(id).pipe(
                    map((result) => fromPermissionActions.doFetchPermissionSuccess({ permission: result.data })),
