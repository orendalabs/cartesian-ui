...
@NgModule({
  declarations: [AuthorizationComponent, RoleListComponent, RoleCreateComponent, PermissionAttachComponent, PermissionListComponent, RoleDetailComponent, RoleManageComponent, PermissionDetailComponent],
  imports: [
    CommonModule,
