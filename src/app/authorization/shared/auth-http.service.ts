...
import { Adapter, Body, Criteria, DefaultHeaders, DELETE, GET, Header, HttpService, Path, POST, RequestCriteria,  } from "@cartesian-ui/ng-axis";
...
export class AuthHttpService extends HttpService {
    ...
    @GET('/permissions')
    public fetchPermissions(@Body criteria: RequestCriteria<any>): Observable<any> {
        return null;
    }
