export interface ICountryUpdateForm {
  id: string;
  name: string;
  native: string;
  alpha2: string;
...
export class CountryUpdateForm implements ICountryUpdateForm {
  public id: string;
  public name: string;
  ...
  constructor(data?: ICountryUpdateForm) {
    if (data) {
  ...
  static fromJSON(data: any): CountryUpdateForm {
    data = typeof data === 'object' ? data : {};
    const result = new CountryUpdateForm();
    result.init(data);
    return result;
  }
