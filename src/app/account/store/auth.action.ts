 ...
 * User Actions
 */
export const fetchUserAction = createAction(type('[Auth] Fetch User'));
export const fetchUserSuccessAction = createAction(type('[Auth] Fetch User Success'), props<{ user: User }>());
export const fetchUserFailAction = createAction(type('[Auth] Fetch User Fail'));
export const addUserAction = createAction(type('[Auth] Add User'), props<{ user: User }>());
export const removeUserAction = createAction(type('[Auth] Remove User'));
